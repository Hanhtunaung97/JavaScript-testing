...
const chars=new Array("c","a","d","b","f","e");
// console.log(chars);
// chars.sort();
// chars.reverse();
// console.log(chars);
...
// console.log(points);
// console.log(points.concat(chars).concat(points).concat("tiger").concat("suPone"));
const arr=[...chars,...points,..."h","t"]
// console.log(arr);
const obj1={
    a:"a",
    b:"b",
...
// console.log(points.unshift("hello"));
// console.log(points.push("world"));
// console.log(points.sort());
// console.log(points.reverse());
// console.log(points.toReversed());

// for (point of points) {
//     console.log(point);
// }
// points.forEach(function(el,index,arr){
...
// const run=x=>"this is run"+9;
// const run = x =>{
    //     console.log(x);
    //     return "this is run"+" "+x;
// }
// const run =(x,y) => x+y;
// const run=(a,b) => {
    //     let x=3;
    //     let y=2;
    //     return `This is run result ${(a+b)*(x+y)}`
    // }
    // console.log(run(9,1));
    ...
    // console.log(points.includes(33));
    // console.log(points.includes(15));
    // console.log(points.indexOf(52));
    // console.log(points.indexOf(57));
    // console.log(points.indexOf(0));
    // console.log(points.slice(2));
    // console.log(points.slice(2,6));
    // console.log(points.slice(3,7));
    // console.log(points.splice(2));
    // console.log(points.splice(2,3,"a","b","c"));
    // console.log(points);
    ...
    // })
    // console.log(Map);
    // const arr1=points.map(el=> el+15)
    // console.log(arr1);
